$(document).ready(function(){
  ...
  function preencher_combo_cidade(ufd_id) {
    $('[id*=_cidade_id]').html('<option value=""></option>'); //adicionando campo vazio
  ...
  function preencher_combo_cliente(cidade_id) {
    $('#entrega_cliente_id').html('<option value=""></option>'); //adicionando campo vazio
    if (cidade_id != ""){
  ...
  function preencher_combo_motorista(data_da_partida) {
    $('#entrega_motorista_id').html('<option value=""></option>');
    if (data_da_partida != ""){
